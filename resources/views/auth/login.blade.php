            ...
            <div class="card-body">
                <div class="card-content p-2">
                    <div class="text-center">
                        <img src="{{ asset('assets/images/1.png') }}" style="width:300px; center;" alt="logo icon">
                    </div>
                    <br>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            <label for="exampleInputUsername" class="sr-only">NISN/NIP</label>
                            <div class="position-relative has-icon-right">
                                <input type="text" id="exampleInputUsername" class="form-control input-shadow"
                                    placeholder="Enter NSISN/NIP" name="nisn">
